...
imported_name = input()
namesfile = open('imported_names.txt', 'a')
namesfile.write(imported_name)
namesfile.write('\n')
namesfile = open('imported_names.txt', 'r')
name = namesfile.read()
namesfile.close()
# To Import the Age
print("PLease Enter Your Age")
imported_age = input()
agesfile = open('imported_ages.txt', 'a')
agesfile.write(imported_age)
agesfile.write('\n')
agesfile = open('imported_ages.txt', 'r')
age = agesfile.read()
agesfile.close()
...
careersfile = open('imported_career.txt', 'a')
careersfile.write(imported_career)
careersfile.write('\n')
careersfile = open('imported_career.txt', 'r')
